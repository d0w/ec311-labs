...
HD_PWD='X:/Documents/ec311/lab3/lab3/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_device.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_device.tcl
