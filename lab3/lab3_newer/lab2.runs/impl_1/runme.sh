...
HD_PWD='X:/Documents/ec311/lab3/lab3/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_device.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_device.tcl -notrace
