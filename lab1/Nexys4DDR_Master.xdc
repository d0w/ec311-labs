...
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { c_in }]; #IO_25_34 Sch=sw[9]
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { mode[1] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
